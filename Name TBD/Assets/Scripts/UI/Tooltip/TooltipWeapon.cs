...
{
    private static TooltipWeapon instance;
    ...
    private void ShowTooltip(EquipmentObject equipmentItem)
    {
        ...
        damage.text = "Damage: " + equipmentItem.baseDamage;
    ...
    public static void ShowTooltipStatic(EquipmentObject equipmentObject)
    {
        instance.ShowTooltip(equipmentObject);
    }
